...
import controller.KhuPhoController;
import model.KhuPho;
...
//========================================================================
	...
	public Main() {
		...
		JLabel lblFromSeasideTo = new JLabel(" Phần mềm Quản lý khu phố");
...
//					
		...
		JMenuItem mntmHongHip = new JMenuItem("Thành Công");
		mntmHongHip.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		mntmHongHip.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Sinh viên: Phạm Thành Công - 20182392", "Bài cuối kỳ môn lập trình nâng cao", JOptionPane.INFORMATION_MESSAGE);
