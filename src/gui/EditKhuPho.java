...
//=====================================================================================
	...
	private void addControls() {
		...
		pnHoDan.setBackground(Color.cyan);
		...
		btnLuuHoDan.setBounds(100, 250, 50, 25);
		...
		pnHoDan.setBorder(new TitledBorder( "Thông tin hộ dân"));
		pnLeft.add(pnHoDan);
		pnDetail.add(pnLeft);
		...
		JLabel lblFromSeasideTo = new JLabel("Quản lý khu phố");
